(function ($) {
    ...
    $(".accordion-item__head").click(function () {
        ...
        $(this).parent(".accordion-item").toggleClass("expanded");
    });

    $(".view-carousel .view-content").addClass("owl-carousel");

    $(".view-doctors-block .owl-carousel").owlCarousel({
        loop: true,
        margin: 20,
        nav: true,
        dots: false,
    ...
    $(".view-doctors-certificates .owl-carousel").owlCarousel({
        loop: true,
        margin: 20,
        nav: true,
        dots: false,
